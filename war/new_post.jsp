            ...
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                <form action="send" method="post">
            		<div class="form-group">
                		...
                		<textarea name="heading" rows="2" cols="60"></textarea>
                	</div>
                	<div class="form-group">
                	...
                	<div class="form-group">
                		<input style="width: 100px;" class="btn btn-default" type="submit" value="Post"/>
                		<a href="posts.jsp" style="width: 110px;" class="btn btn-danger">Cancel</a>
